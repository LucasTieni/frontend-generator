...
public class VercelService {
	...
	@Autowired
	private VercelProperties vercelProperties;
	
	public void createProject(String projectName, String githubRepoFullName) {
		String url = vercelProperties.getUrl() + "/v9/projects";
...
//		headers.add("Accept", "application/vnd.github+json");
		headers.add("Authorization", "Bearer "+ vercelProperties.getToken());
		return headers;
	}
